...
def main():
    ...
    for d in dirs:
        ...
        ax[0].plot(data2_rec[i_q_rec, 0], y2_med_xps[i_q_rec],
                   color='tab:orange')
        ax[0].plot(data2_rec[i_q_rec, 0], ampops*y2_med_ops[i_q_rec],
                   color='tab:blue')
        ax[0].fill_between(data2_rec[i_q_rec, 0], y2_low_xps[i_q_rec],
                           y2_hig_xps[i_q_rec], color='tab:orange', alpha=.5)
        ax[0].fill_between(data2_rec[i_q_rec, 0], ampops*y2_low_ops[i_q_rec],
                           ampops*y2_hig_ops[i_q_rec],
        ...
        ax[1].plot(data1_rec[i_q_rec, 0], y1_med_xps[i_q_rec],
                   color='tab:orange')
        ax[1].plot(data1_rec[i_q_rec, 0], ampops*y1_med_ops[i_q_rec],
                   color='tab:blue')
        ax[1].fill_between(data1_rec[i_q_rec, 0], y1_low_xps[i_q_rec],
                           y1_hig_xps[i_q_rec], color='tab:orange', alpha=.5)
        ax[1].fill_between(data1_rec[i_q_rec, 0], ampops*y1_low_ops[i_q_rec],
                           ampops*y1_hig_ops[i_q_rec],
                           color='tab:blue', alpha=.5)
